...
using Learn.Bit.Server.Api;
using Learn.Bit.Server.Web;
using Microsoft.AspNetCore.Builder;
using Microsoft.AspNetCore.Hosting;
using Microsoft.Extensions.Hosting;

namespace Learn.Bit.Tests;
public partial class AppTestServer : IAsyncDisposable
{
        ...
        Action<ConfigurationManager>? configureTestConfigurations = null)
    {
        ...
        builder.Configuration["ConnectionStrings:SqliteConnectionString"] = "Data Source=Learn.BitDb;Mode=Memory;Cache=Shared;";
